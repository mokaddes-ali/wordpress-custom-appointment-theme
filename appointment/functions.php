...
require_once get_template_directory() . '/template-part/sections/header-section.php';
require_once get_template_directory() . '/template-part/sections/header-top.php';
require_once get_template_directory() . '/template-part/sections/footer-section.php';
